...
import { IntroductionOopQuizService } from '../../../services/introduction-oop-quiz.service';

@Component({
  selector: 'app-introduction-oop',
  templateUrl: './introduction-oop.component.html',
  styleUrl: './introduction-oop.component.scss'
})
export class IntroductionOopComponent implements OnInit{
newQuiz: any = {};
      quizzes: any[] = [];
      loading = false;
      showAddModal = false; 
      ...
      constructor(
        private abstractionQuizService: IntroductionOopQuizService,
