...
import { IntroductionJavaQuizService } from '../../../services/introduction-java-quiz.service';

@Component({
  selector: 'app-introduction-java',
  templateUrl: './introduction-java.component.html',
  styleUrl: './introduction-java.component.scss'
})
export class IntroductionJavaComponent implements OnInit{
newQuiz: any = {};
      quizzes: any[] = [];
      loading = false;
      showAddModal = false; 
      ...
      constructor(
        private abstractionQuizService: IntroductionJavaQuizService,
