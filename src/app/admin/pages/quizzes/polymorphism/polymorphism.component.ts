...
import { PolymorphismQuizService } from '../../../services/polymorphism-quiz.service';

@Component({
  selector: 'app-polymorphism',
  templateUrl: './polymorphism.component.html',
  styleUrl: './polymorphism.component.scss'
})
...
newQuiz: any = {};
      ...
      constructor(
        private abstractionQuizService: PolymorphismQuizService,
