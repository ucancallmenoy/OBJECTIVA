...
@Component({
  selector: 'app-exercise4-polymorphism',
  templateUrl: './exercise4-polymorphism.component.html',
  styleUrl: './exercise4-polymorphism.component.scss'
})
  ...
  hintIndex: number;
      ...
      getHint(): void {
          if (this.hintIndex < this.hints.length) {
            ...
            levels: GameLevel[] = [
              {
                images: ['assets/o1.png', 'assets/o2.png', 'assets/o3.png', 'assets/o4.png'],
