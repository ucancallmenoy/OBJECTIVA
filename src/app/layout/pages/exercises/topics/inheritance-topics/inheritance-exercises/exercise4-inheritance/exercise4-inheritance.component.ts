...
@Component({
  selector: 'app-exercise4-inheritance',
  templateUrl: './exercise4-inheritance.component.html',
  styleUrl: './exercise4-inheritance.component.scss'
})
export class Exercise4InheritanceComponent {
  ...
  hintIndex: number;
    ...
    constructor(){
      ...
      this.hints = [
        "Hint 1: This keyword is used to create a child class from a parent class.",
        "Hint 2: It allows a class to inherit properties and methods from another class.",
        "Hint 3: In TypeScript and Java, this keyword is used to establish an inheritance relationship.",
      ];
    }
